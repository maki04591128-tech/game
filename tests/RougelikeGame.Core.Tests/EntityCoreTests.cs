...
public class EntityCoreTests
{
    ...
    [InlineData(StatusEffectType.Vulnerability, 1.0f, 0.6f, 0)]
    [InlineData(StatusEffectType.Strength, 1.3f, 1.0f, 0)]
    [InlineData(StatusEffectType.Blessing, 1.15f, 1.15f, 0)]
